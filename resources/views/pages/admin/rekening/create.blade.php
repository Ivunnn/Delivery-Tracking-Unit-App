...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white/90">Tambah Rekening</h2>
    </div>

    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
        <form method="POST" action="{{ route('admin.rekening.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="no_rekening" name="no_rekening"
                        ...
                        class="h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm font-mono text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="atas_nama" name="atas_nama"
                        value="{{ old('atas_nama', 'CV. Anugerah Bojonegoro') }}"
                        class="h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
