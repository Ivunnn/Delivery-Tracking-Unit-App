                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        {{-- Thumbnail --}}
                                        <div
                                            class="w-10 h-10 rounded-lg overflow-hidden border border-gray-100 dark:border-gray-700 shrink-0 bg-gray-50 dark:bg-gray-800">
                                            @if ($unit->foto)
                                                <img src="{{ $unit->foto_url }}" alt="{{ $unit->tipe_motor }}"
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium capitalize {{ $badge[$unit->status] ?? '' }}">
                                        {{ ucfirst($unit->status) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4">
