                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" id="no_rangka" name="no_rangka" value="{{ old('no_rangka') }}"
                            placeholder="Contoh: MH1JFP110PK000001" class="h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 font-mono
                    ...
                    <div>
                        <label for="tipe_motor" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Tipe Motor/Mobil <span class="text-error-500">*</span>
                        </label>
                        <input type="text" id="tipe_motor" name="tipe_motor" value="{{ old('tipe_motor') }}"
                            placeholder="Contoh: Honda Beat ESP" class="h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30
                    ...
                    <div>
                        ...
                        <input type="text" id="warna" name="warna" value="{{ old('warna') }}" placeholder="Contoh: Hitam"
                    ...
                    <div>
                        ...
                        <input type="number" id="tahun" name="tahun" value="{{ old('tahun', date('Y')) }}" min="2000"
                            max="{{ date('Y') }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="harga" name="harga" value="{{ old('harga') }}"
                            placeholder="Contoh: 17500000" min="0"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        @error('keterangan')
                            <p class="mt-1.5 text-xs text-error-500">{{ $message }}</p>
                        @enderror
                        <form method="POST" action="{{ route('admin.units.store') }}" enctype="multipart/form-data" {{-- ← wajib
                            untuk upload file --}} class="space-y-5">
                            {{-- Foto Unit --}}
                            <div class="sm:col-span-2">
