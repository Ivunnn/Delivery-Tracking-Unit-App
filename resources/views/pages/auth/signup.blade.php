                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Isi email dan kata sandi untuk membuat akun!
                        </p>
                    </div>
                    <div>
                        <form>
                                ...
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Nama awal<span class="text-error-500">*</span>
                                        </label>
                                    ...
                                    <div class="sm:col-span-1">
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Nama akhir<span class="text-error-500">*</span>
                                        </label>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Sudah punya akun?
                                <a href="/" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Masuk</a>
                            </p>
                        </div>
                    </div>
                </div>
