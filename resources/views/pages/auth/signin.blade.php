    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            <div class="bg-brand-950 dark:bg-white/5 relative hidden h-full w-full items-center lg:grid lg:w-1/2 bg-cover bg-center bg-no-repeat"
                ...
                <!-- Konten Logo -->
                <!-- Ubah z-1 menjadi 'relative z-10' agar logo tampil di atas overlay -->
                        ...
                        <div>
                            <form method="POST" action="{{ route('signin.post') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    @if ($errors->any())
                                        <div
                                            class="rounded-lg border border-error-200 bg-error-50 px-4 py-3 dark:border-error-500/30 dark:bg-error-500/15">
                                    ...
                                    @if (session('success'))
                                        <div
                                            class="rounded-lg border border-success-200 bg-success-50 px-4 py-3 dark:border-success-500/30 dark:bg-success-500/15">
