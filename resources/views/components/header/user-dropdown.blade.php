<div class="relative" x-data="{
    ...
    <!-- User Trigger -->
    <button class="flex items-center text-gray-700 dark:text-gray-400" type="button" @click="toggleDropdown()">
    ...
    <div x-show="isOpen" x-transition:enter="transition ease-out duration-100"
        ...
        <ul class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
            ...
            <li class="relative" @click.outside="subDropdownOpen = false">
                <button type="button" @click.stop="subDropdownOpen = !subDropdownOpen"
                    ...
                    <span
                        ...
                        <img :src="'/images/icons/' + currentLang.flag" :alt="currentLang.shortName"
                            class="size-3.5 shrink-0 overflow-hidden rounded-full object-cover" />
                    </span>
                </button>

                <!-- Submenu Flyout -->
                <div x-show="subDropdownOpen" x-transition:enter="transition ease-out duration-100"
                            ...
                            <li>
                                <button type="button" @click="selectLanguage(lang)"
                                    ...
                                    <span class="flex items-center gap-2">
                                        <span class="size-1.5 shrink-0 rounded-full transition-opacity"
                                            :class="currentLocale === lang.id ? 'bg-brand-500 opacity-100 dark:bg-brand-400' : 'opacity-0'"></span>
                                        <img :src="'/images/icons/' + lang.flag" :alt="lang.name"
